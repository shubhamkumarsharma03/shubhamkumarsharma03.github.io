// Typing Animation with Repeat
const typedTextElement = document.getElementById('typed-name');
const textToType = 'Shubham Kumar Sharma';
let charIndex = 0;
let isTyping = true;
let hasScrolled = false;

function typeText() {
  if (!isTyping || hasScrolled) return;
...
function deleteText() {
  ...
  if (charIndex > 0) {
    ...
    charIndex--;
    setTimeout(deleteText, 50); // Delete speed (faster)
  } else {
